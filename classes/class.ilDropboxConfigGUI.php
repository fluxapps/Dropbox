...
include_once("./Modules/Cloud/classes/class.ilCloudPluginConfigGUI.php");
...
class ilDropboxConfigGUI extends ilCloudPluginConfigGUI
{
    ...
    public function getFields()
    {
        return array(
            ...
            "config_default_online"        => array("type" => "ilCheckboxInputGUI", "info" => "config_info_default_online", "subelements" => null),
            ...
            "default_allow_public_links"     => array("type" => "ilCheckboxInputGUI", "info" => "default_info_config_allow_public_links", "subelements" => array("config_allow_public_links" => array("type" => "ilCheckboxInputGUI", "info" => "config_default_config_allow_public_links_info", "subelements" => null))),
        );
    }
}
